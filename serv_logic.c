...
int main(int argc, char **argv)
{
    ...
    //here i fill my hashstruct with processes info
	...
	if (whatprog == 3) { //here i print system info
		printf("kek");
		int buffer_num;
		char buffer[100];
